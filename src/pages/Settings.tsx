...
import SettingsSidebar, { SettingsTab } from '../features/settings/components/SettingsSidebar';
import SettingsProfileTab from '../features/settings/components/SettingsProfileTab';
import SettingsIntegrationsTab from '../features/settings/components/SettingsIntegrationsTab';
import SettingsHousingTab from '../features/settings/components/SettingsHousingTab';
import SettingsDocumentsTab from '../features/settings/components/SettingsDocumentsTab';
import SettingsDataTab from '../features/settings/components/SettingsDataTab';
