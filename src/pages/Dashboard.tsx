    ...
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      <header className="flex justify-between items-end">
        ...
        <div className="flex gap-3">
          <button className="px-6 py-3 bg-white text-slate-600 font-bold rounded-2xl border border-pine-100 shadow-sm hover:bg-slate-50 transition-all text-sm">
            Descargar Reporte
          </button>
          <button className="px-6 py-3 bg-pine-900 text-white font-bold rounded-2xl shadow-lg shadow-pine-900/20 hover:bg-pine-800 transition-all text-sm flex items-center gap-2">
            Nuevo Lead <ArrowUpRight size={18} />
          </button>
        </div>
      </header>

      {/* Grid de Estadísticas con Estilo de Capturas */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white rounded-4xl p-8 border border-pine-100 shadow-sm">
          <div className="flex justify-between items-center mb-8">
            ...
            <select className="bg-pine-50 border-none rounded-xl text-xs font-bold p-2 outline-none">
        ...
        <div className="bg-pine-900 rounded-4xl p-8 shadow-2xl shadow-pine-900/30 text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl hover:bg-white/10 transition-colors cursor-pointer group">
                  <div className="w-10 h-10 bg-pine-600 rounded-xl flex items-center justify-center font-bold text-xs">
                    0{i+9}
                  </div>
            ...
            <button className="w-full mt-6 py-4 bg-white text-pine-900 font-bold rounded-2xl text-xs uppercase tracking-widest hover:bg-pine-100 transition-colors">
              Ver Calendario
            </button>
          </div>
